...
CREATE TABLE `handler` (
  `idhandler` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(45) NOT NULL,
  `password` varchar(45) NOT NULL,
  PRIMARY KEY (`idhandler`,`username`),
  UNIQUE KEY `idhandler_UNIQUE` (`idhandler`),
...
INSERT INTO `handler` VALUES (1,'marcolito',''),(2,'marcosito','ciao');
